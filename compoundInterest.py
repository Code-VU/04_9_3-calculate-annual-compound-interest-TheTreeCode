def getACompoundInterest():
    while True:
        try:
            ...
            print("Please enter only numeric values without any text or special characters.")
            continue
    while True:
        try:
...
def calculateCompoundInterest():
    ...
    #The function being passed to the "principal_time_rate_LIST" variable returns a list with [principal, time, rate].
